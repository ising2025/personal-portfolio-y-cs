  ...
  const projects = [
    {
      ...
      description: "Trained CNN to detect the severity of diabetic retinopathy in patient retinal scans.",
    ...
    },
    {
      ...
      description: "Augmented sign language dataset using novel SDG algorithm and trained LLM to translate between English and ASL.",
    ...
    },
    {
      ...
      description: "Used unsupervised learning (K-means clustering) and sentiment analysis to detect bullying comments on TikTok.",
